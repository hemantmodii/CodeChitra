...
export default async function Layout({
  ...
  return (<SessionProvider value={session}>
    <div className="flex min-h-screen flex-col bg-secondary">
      <Navbar/>
    <div className="max-w-[85rem] mx-auto p-5 flex w-full grow gap-5">
      ...
      {children}</div>
      <MenuBar className="sticky bottom-0 flex w-full justify-center gap-5 border-t bg-primary p-3 sm:hidden"/>
    </div>
  </SessionProvider>)
}
